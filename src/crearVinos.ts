...
export const crearVinosAutomaticos = (cantidad:number) => {
...
function booleanoAleatorio(): boolean {
...
// Ejemplo de uso:
export const crearResenaAleatoria = (vino:Vino) => {
